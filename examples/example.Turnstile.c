/*
 * Death By Captcha — C client example: Cloudflare Turnstile (type 12).
 *
...
#define SITEKEY  "0x4AAAAAAABkMYinukE8nzYD"
...
int main(void)
{
    ...
    if (dbc_decode_token(&client, &captcha, 12, "turnstile_params",
